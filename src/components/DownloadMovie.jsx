...
const WatchNowModal = ({ isOpen, onClose, movie }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-start justify-center z-50 p-0 sm:p-4 sm:py-2">
      <div className="bg-gray-900 rounded-none sm:rounded-lg w-full h-full sm:w-[95vw] sm:h-[98vh] lg:w-[90vw] lg:h-[95vh] xl:w-[85vw] xl:h-[90vh] overflow-hidden shadow-2xl flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
          ...
          {/* Right Column - Movie Details (Desktop) / Bottom Section (Mobile) */}
          <div className="lg:w-1/3 lg:border-l lg:border-gray-700 flex-1 overflow-y-auto">
        ...
        {/* Bottom Section - Movie Recommendations (Full Width) */}
        <div className="border-t border-gray-700 bg-gray-900 overflow-y-auto max-h-[40vh] lg:max-h-[35vh]">
